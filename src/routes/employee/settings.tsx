...
export const Route = createFileRoute("/employee/settings")({ component: EmployeeSettings });

const notificationSettings = [
  { id: "leave_approval", label: "Leave approvals", desc: "When your leave is approved or rejected", email: true, push: true, sms: false },
  { id: "payslip", label: "Payslip available", desc: "When a new payslip is generated", email: true, push: true, sms: false },
  { id: "task_assigned", label: "Task assigned", desc: "When a new task is assigned to you", email: false, push: true, sms: false },
  { id: "announcements", label: "Company announcements", desc: "New company-wide announcements", email: true, push: false, sms: false },
  { id: "ticket_update", label: "Support ticket updates", desc: "When your ticket status changes", email: true, push: true, sms: true },
  { id: "birthday", label: "Birthday reminders", desc: "Colleague birthday notifications", email: false, push: true, sms: false },
  { id: "training_due", label: "Training due reminders", desc: "Reminders for upcoming training deadlines", email: true, push: true, sms: false },
];
...
function EmployeeSettings() {
  ...
  return (
    <PortalShell role="employee" title="Settings" subtitle="Password, notifications and security">
                  ...
                  <div key={n.id}>
                    ...
                    <div className="grid grid-cols-4 gap-4 items-center px-1">
                      ...
                      <div className="flex justify-center">
                        <Switch checked={n.email} onCheckedChange={() => toggle(n.id, "email")} />
                      </div>
                      <div className="flex justify-center">
                        <Switch checked={n.push} onCheckedChange={() => toggle(n.id, "push")} />
                      </div>
                    </div>
                  </div>
                ))}
